...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield prisma.country.createMany({
            data: countries,
            skipDuplicates: true,
        });
        // ✅ Fetch Nepal to use as default country
        const country = yield prisma.country.findFirst({
            where: { code: "NP" },
        });
        if (!country)
            throw new Error("Nepal not found in database!");
        // 2️⃣ Province
        const province = yield prisma.province.create({
            data: {
        ...
        // 4️⃣ Users
        const chairman = yield prisma.user.create({
            data: {
                fullName: "Rajesh Sharma",
                email: "rajesh@ngo.org",
                password: "hashedpassword123",
                role: client_1.UserRole.chairman,
                countryId: country.id,
                provinceId: province.id,
        ...
        const volunteer = yield prisma.user.create({
            data: {
            ...
            data: [
                {
                    ...
                    amount: 10000,
                    method: client_1.DonationMethod.online,
                ...
                },
                {
                    ...
                    amount: 5000,
                    method: client_1.DonationMethod.cash,
        ...
        // 7️⃣ Expenses
        yield prisma.expense.createMany({
            data: [
                {
                    amount: 2000,
