...
exports.addLegalCaseController = (0, asyncHandler_js_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!title || !category) {
        return res.status(400).json(new apiResponse_js_1.default(false, 400, 'Title and Category are required.', null));
    }
    let documents = [];
    ...
    return res.status(201).json(new apiResponse_js_1.default(true, 201, 'Legal Case created successfully.', newCase));
}));
...
exports.editLegalCaseController = (0, asyncHandler_js_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res.status(200).json(new apiResponse_js_1.default(true, 200, 'Legal Case updated successfully.', updatedCase));
}));
...
exports.changeLegalCaseStatusController = (0, asyncHandler_js_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!Object.values(client_1.LegalCaseStatus).includes(newStatus)) {
        return res.status(400).json(new apiResponse_js_1.default(false, 400, `Invalid status value. Must be one of: ${Object.values(client_1.LegalCaseStatus).join(', ')}.`, null));
    }
    const updatedCase = yield db_js_1.default.legalCase.update({
        where: { id: caseId },
    ...
    return res.status(200).json(new apiResponse_js_1.default(true, 200, `Status changed to ${newStatus}.`, updatedCase));
}));
// --- 6. DELETE LegalCase ---
